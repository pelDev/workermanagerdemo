...
import com.peldev.workmanagerdemo.databinding.ActivityBlurBinding;
...
public class BlurActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // set up observer for save worker
        ...
        // Setup see output file button
        binding.seeFileButton.setOnClickListener(view -> {
            Uri contentUri = mViewModel.getOutputUri();
            if (contentUri != null) {
                Intent actionView = new Intent(Intent.ACTION_VIEW, contentUri);
